...
List <qns> level1=[
  ...
  qns(qn: 'A bus has a seating capacity of 35 people. How many people  can travel in 35 bus of same seating capacity?', ans: 1225, clr:0xFFFF007F,con: 'tc3'),
  qns(qn: 'A man has 78 notes of ₹50.  How much money does he possess?', ans: 3900, clr:0xFF15F4EE,con: 'tc4'),
  ...
  qns(qn: 'Ram started making chocolates. One day he has 19 customers and each one orders 11 chocolates. How many chocolates does he make?', ans:209, clr: 0xFFFF007F,con: 'tc7'),
  qns(qn: 'Nick delivers 78 newspapers daily. How many newspapers does he deliver in 79 days?', ans: 6162, clr:0xFF15F4EE,con: 'tc8'),
...
List <qns> level2 =[
  ...
  qns(qn: 'A school ordered 60 boxes of paper. There were 31 sheets of paper in each box. Each paper costs ₹1. What is the total cost of the paper?', ans: 1860, clr:0xFFFF007F,con: 'tb2'),
  qns(qn: 'The length and breadth of a rectangular park is 223 cm and 227 cm. Find the area of the park?', ans: 50621, clr:0xFF15F4EE,con: 'tb3'),
  ...
  qns(qn:'An orchard has 12 rows of mango trees. If there are 13 trees in each row. If each trees have 154 mangoes, What is the total number of mango trees in the orchard?', ans: 24024, clr: 0xFFFF007F,con: 'tb6'),
  qns(qn: 'Our heart beats about 72 times in a minute. How many times will it beat in an hour?', ans: 4320, clr:0xFF15F4EE,con: 'tb7'),
  ...
  qns(qn: 'A packet contains 115 of candles. How many candles are there in 115 packets?', ans: 13225, clr: 0xFFFF007F,con: 'tb10')
];
...
class _quizState extends State<quiz> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xFF240831),
        title: Text('Let\'s use the vedic sutras',style: TextStyle(color: Colors.white,fontFamily: 'CaveatBrush',fontSize: 30),),
        centerTitle: true,
        bottom: TabBar(
          indicatorColor: Colors.white,
          tabs: [
          Tab(child: Text('Level 1',style: TextStyle(color: Colors.white,fontFamily: 'CaveatBrush'),),),
         Tab(child: Text('Level 2',style: TextStyle(color: Colors.white,fontFamily: 'CaveatBrush'),),)
        ],),
      ),
      body: TabBarView(
        children: <Widget>[
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children:<Widget>[
                Text(qn,style: TextStyle(color: Colors.black,fontFamily: 'CaveatBrush',fontSize: 30),),
                TextFormField(
                  decoration : InputDecoration(
                    border: InputBorder.none,
                    hintText: 'Answer here',
                    hintStyle: TextStyle(color: Colors.black,fontFamily: 'CaveatBrush'),
                    errorStyle: TextStyle(color: Colors.black,fontFamily: 'CaveatBrush',fontSize: 15),
                  ),
                  validator: (con){
                ...
                }, child: Text('check',style:TextStyle(color: Colors.black,fontFamily: 'CaveatBrush',))),

                 Text(txt,style:TextStyle(color: Colors.black,fontFamily: 'CaveatBrush',fontSize: 30),),
              ]
            ),
          ),
        ),
